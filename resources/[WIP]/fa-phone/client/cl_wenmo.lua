...
RegisterNUICallback('wenmoSubmit', function(data)
    ...
    TriggerServerEvent('fa-phone:transferWenmo',num,amount,comment)
end)

RegisterNUICallback("fa-phone:getWenmo", function(data, cb)
    local success, message = RPC.execute("fa-phone:getWenmo")
    local wenmo = {}
