...
RegisterNUICallback("fa-ui:pingSend", function(data, cb)
...
RegisterNUICallback("fa-ui:pingAccept", function(data, cb)
...
RegisterNUICallback("fa-ui:pingReject", function(data, cb)
