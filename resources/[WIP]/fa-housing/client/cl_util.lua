...
function canRent()
    ...
    if isComplete and dist <= 3.0 then
        ...
        local canRent = RPC.execute("fa-housing:canRent", propertyId)
...
AddEventHandler("fa-housing:handler", function(data, cb)
...
Citizen.CreateThread(function()
    exports["fa-keybinds"]:registerKeyMapping("","Housing", "Interact", "+propertyInteract", "-propertyInteract", "E")
