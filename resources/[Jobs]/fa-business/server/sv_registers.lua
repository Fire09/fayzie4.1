...
RPC.register("fa-business:startPurchase", function(pSource, pData)
    ...
    TriggerClientEvent("fa-business:activePurchase", -1, insert)
end)
...
RPC.register("fa-business:completePurchase", function(pSource, pData)
    ...
    local owner = exports["fa-base"]:getModule("Player"):GetUser(data.charger)
    ...
    TriggerClientEvent("fa-business:closePurchase", -1, insert)

    TriggerClientEvent('fa-phone:businessRegisterNoti', pSource, "SERVICE CHARGE", message)
