...
RPC.register("fa-business:business:GetEmploymentInformation", function(pSource)
    local user = exports["fa-base"]:getModule("Player"):GetUser(pSource)
    local char = user:getCurrentCharacter()
...
RPC.register("fa-business:phone:GetEmploymentInformation", function(pSource)
    local user = exports["fa-base"]:getModule("Player"):GetUser(pSource)
    local char = user:getCurrentCharacter()
...
RPC.register("fa-business:business:hasPermission", function(pSource, pBusinessId, pType)
    local hasPermission
...
RPC.register("fa-business:hasPermission", function(pSource, pBusinessId)
    local hasPermission
    local user = exports["fa-base"]:getModule("Player"):GetUser(pSource)
    local char = user:getCurrentCharacter()
    local tableh = {}
...
RPC.register("fa-business:business:createRole", function(pSource, pBusinessId, pRoleName, pPermHire, pPermFire, pPermChangeRoles, pPermKeys, pPermStash, pPermCraft, pPermCharge, pPermBank, pPermLogs)
    local data = Await(SQL.execute("SELECT * FROM businesses WHERE business_id = @business_id", {
        ["business_id"] = pBusinessId
    }))
    local user = exports['fa-base']:getModule("Player"):GetUser(pSource)
...
RPC.register("fa-business:phone:createRole", function(pSource, pBusinessId, pRoleName, pPermFire, pPermHire, pPermChangeRoles, pPermKeys, pPermStash, pPermCraft, pPermCharge, pPermBank, pPermLogs)
    local data = Await(SQL.execute("SELECT * FROM businesses WHERE business_id = @business_id", {
        ["business_id"] = pBusinessId
    }))
...
RPC.register("fa-business:business:checkRoleExistance", function(pSource, pBusinessId, pCurRole)
    local data = Await(SQL.execute("SELECT * FROM businesses WHERE business_id = @business_id", {
        ["business_id"] = pBusinessId
    }))
        local bool = false
...
RPC.register("fa-business:phone:checkRoleExistance", function(pSource, pBusinessId, pCurRole)
    local data = Await(SQL.execute("SELECT * FROM businesses WHERE business_id = @business_id", {
        ["business_id"] = pBusinessId
    }))
        local bool = false
...
RPC.register("fa-business:business:editRole", function(pSource, pBusinessId, pCurRole, pRoleName, pPermFire, pPermHire, pPermChangeRoles, pPermKeys, pPermStash, pPermCraft, pPermCharge, pPermBank, pPermLogs)
...
RPC.register("fa-business:business:deleteRole", function(pSource, pBusinessId, pRole)
...
RPC.register("fa-business:phone:deleteRole", function(pSource, pBusinessId, pRole)
    local role = firstToUpper(pRole)
    local data = Await(SQL.execute("SELECT * FROM businesses WHERE business_id = @business_id", {
        ["business_id"] = pBusinessId
    }))
...
RPC.register("fa-business:business:updateEmployee", function(pSource, pCid, pBusinessId, pNewRole)
    local data = Await(SQL.execute("SELECT * FROM businesses WHERE business_id = @business_id", {
        ["business_id"] = pBusinessId
    }))
...
RPC.register("fa-business:phone:updateEmployee", function(pSource, pCid, pBusinessId, pNewRole)
    local data = Await(SQL.execute("SELECT * FROM businesses WHERE business_id = @business_id", {
        ["business_id"] = pBusinessId
    }))
...
RPC.register("fa-business:business:hireEmployee", function(pSource, pCid, pRole, pBusinessId)
    local data = Await(SQL.execute("SELECT * FROM businesses WHERE business_id = @business_id", {
        ["business_id"] = pBusinessId
    }))
        local employees = nil
...
RPC.register("fa-business:phone:hireEmployee", function(pSource, pCid, pRole, pBusinessId)
    local data = Await(SQL.execute("SELECT * FROM businesses WHERE business_id = @business_id", {
        ["business_id"] = pBusinessId
    }))
        local employees = nil
...
RPC.register("fa-business:business:fireEmployee", function(pSource, pCid, pBusinessId)
    local data = Await(SQL.execute("SELECT * FROM businesses WHERE business_id = @business_id", {
        ["business_id"] = pBusinessId
    }))
...
RPC.register("fa-business:phone:fireEmployee", function(pSource, pCid, pBusinessId)
    local data = Await(SQL.execute("SELECT * FROM businesses WHERE business_id = @business_id", {
        ["business_id"] = pBusinessId
    }))
...
RPC.register("fa-business:business:GetEmploymentInformationBusinessID", function(pSource, pCid, pBusinessId)
...
RPC.register("fa-businesses:getRoleAndEmployeesList", function(pSource, pBID)
    local data = Await(SQL.execute("SELECT * FROM businesses WHERE business_id = @business_id", {
        ["business_id"] = pBID
    }))
    local employees = json.decode(data[1].employees) or {}
...
RPC.register("fa-business:phone:GetRolePermission", function(pSource, pBusinessId, pRole)
    local data = Await(SQL.execute("SELECT * FROM businesses WHERE business_id = @business_id", {
        ["business_id"] = pBusinessId
    }))
...
RPC.register("fa-business:business:GetEmploymentInformationBusinessID:Full", function(pSource, pBusinessId)
    local data = Await(SQL.execute("SELECT * FROM businesses WHERE business_id = @business_id", {
        ["business_id"] = pBusinessId
    }))
    local luckylucky = {}
...
RPC.register("fa-business:phone:GetEmploymentInformationBusinessID", function(pSource, pCid, pBusinessId)
    local userInfo = Await(SQL.execute("SELECT first_name, last_name FROM characters WHERE id = @id", {
        ["id"] = pCid
    }))
...
RPC.register("fa-business:business:GetBusiness", function(pSource, pBusinessId)
    local data = Await(SQL.execute("SELECT * FROM businesses WHERE business_id = @business_id", {
        ["business_id"] = pBusinessId
    }))
    local employment = {}
...
RPC.register("fa-business:phone:GetBusiness", function(pSource, pBusinessId)
    local data = Await(SQL.execute("SELECT * FROM businesses WHERE business_id = @business_id", {
        ["business_id"] = pBusinessId
    }))
    local employment = {}
...
RPC.register("fa-business:business:GetOwner", function(pSource, pBusinessId)
...
RPC.register("fa-business:business:GetBusinessRoles", function(pSource, pBusinessId)
    local data = Await(SQL.execute("SELECT * FROM businesses WHERE business_id = @business_id", {
        ["business_id"] = pBusinessId
    }))
            local allroles = {}
...
RPC.register("fa-business:phone:GetBusinessRoles", function(pSource, pBusinessId)
    local data = Await(SQL.execute("SELECT * FROM businesses WHERE business_id = @business_id", {
        ["business_id"] = pBusinessId
    }))
            local allroles = {}
...
RPC.register("fa-business:business:GetRole", function(pSource, pBusinessId, pRoleName)
    local data = Await(SQL.execute("SELECT * FROM businesses WHERE business_id = @business_id", {
        ["business_id"] = pBusinessId
    }))
...
RPC.register("fa-business:business:addEmployee", function(pSource, pCid, pRole, pBusinessId)
...
RPC.register("fa-business:business:isBizOwner", function(pSource, pBusinessId)
    local user = exports["fa-base"]:getModule("Player"):GetUser(pSource)
    local char = user:getCurrentCharacter()
...
RPC.register("fa-business:business:GetUserRole", function(pSource, pBusinessId, pCid)
    local data = Await(SQL.execute("SELECT * FROM businesses WHERE business_id = @business_id", {
        ["business_id"] = pBusinessId
    }))
            local employees = json.decode(data[1].employees) or {}
...
RPC.register("fa-business:phone:GetUserRole", function(pSource, pBusinessId, pCid)
        local data = Await(SQL.execute("SELECT * FROM businesses WHERE business_id = @business_id", {
            ["business_id"] = pBusinessId
        }))
                local employees = json.decode(data[1].employees) or {}
...
RPC.register("fa-business:business:GetRolePermission", function(pSource, pBusinessId, pRole)
    local data = Await(SQL.execute("SELECT * FROM businesses WHERE business_id = @business_id", {
        ["business_id"] = pBusinessId
    }))
            local roles = json.decode(data[1].roles) or {}
...
RPC.register("fa-business:getBizBank", function(pSource, pBusinessId)
    local data = Await(SQL.execute("SELECT * FROM businesses WHERE business_id = @business_id", {
        ["business_id"] = pBusinessId
    }))
...
RPC.register("fa-business:role:test", function(pSource, pData)
...
RPC.register("fa-business:business:charge", function(pSource, pBusinessId, pCid, pCharger, pAmount, pComment)
    TriggerClientEvent("showPaymentNotify", -1, pBusinessId, pCid, pCharger, pAmount, pComment)
end)

RPC.register("fa-business:phone:charge", function(pSource, pBusinessId, pCid, pCharger, pAmount)
...
RPC.register("chargeCustomer", function(pSource, pBusinessId, pCid, pComment, pCharger, pAmount, pSrc, pDate)
    ...
    local user = exports["fa-base"]:getModule("Player"):GetUser(tonumber(pSrc))
...
RPC.register("fa-business:transferBank", function(pSource, pBusinessId, pAmount)
    local update = Await(SQL.execute("UPDATE businesses SET bank = bank + @amount WHERE business_id = @business_id", {
        ["amount"] = tonumber(pAmount),
        ["business_id"] = pBusinessId
    }))
