...
AddEventHandler("fa-police:startPutInBeatMode", function()
  ...
  TriggerServerEvent("fa-police:sendBeatMode", tplyId)
end)

RegisterNetEvent("fa-police:recieveBeatMode")
AddEventHandler("fa-police:recieveBeatMode", function()
...
AddEventHandler("fa-police:startBeatdownDebuff", function()
