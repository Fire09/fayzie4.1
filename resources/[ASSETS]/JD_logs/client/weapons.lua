...
ClientWeapons.WeaponNames = {
	...
	[tostring(GetHashKey('WEAPON_RFayeR'))] = 'Heavy RFayer',
	[tostring(GetHashKey('WEAPON_RFayeR_MK2'))] = 'Heavy RFayer Mk2',
	[tostring(GetHashKey('WEAPON_DOUBLEACTION'))] = 'Double-Action RFayer',
