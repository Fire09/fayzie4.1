...
AddEventHandler("fa-jobmanager:playerBecameJob", function(jobpassed, name, notify)
	job = jobpassed
    if not job then
        job = "None"
    end
...
AddEventHandler('fa-base:addedMoney', function(blah,amount)
  cash = math.ceil(amount)
end)

RegisterNetEvent('fa-base:removedMoney')
AddEventHandler('fa-base:removedMoney', function(blah,amount)
  cash = math.ceil(amount)
end)
...
function LastVehiclePedWasIn()
  return lastVehicle
end exports('LastVehiclePedWasIn', LastVehiclePedWasIn)
