...
Citizen.CreateThread(function()
	exports["fa-polyzone"]:AddBoxZone("tattoo_shop", vector3(1323.0, -1652.8, 52.28), 4.2, 6.8, {
		heading=40,
		minZ=51.95,
		maxZ=53.95
	})

	exports["fa-polyzone"]:AddBoxZone("tattoo_shop", vector3(-1154.29, -1426.76, 4.95), 4.8, 7.2, {
		heading=32,
		minZ=3.95,
		maxZ=7.95
	})

	exports["fa-polyzone"]:AddBoxZone("tattoo_shop", vector3(323.34, 180.65, 103.59), 5.2, 6.4, {
		heading=337,
		minZ=102.24,
		maxZ=106.64
	})

	exports["fa-polyzone"]:AddBoxZone("tattoo_shop", vector3(-3170.18, 1076.27, 20.83), 7.0, 4.8, {
		heading=335,
		minZ=19.83,
		maxZ=24.03
	})
	...
	-- Julio Garcia House
	exports["fa-polyzone"]:AddBoxZone("tattoo_shop", vector3(330.52, -1947.36, -34.17), 2.7, 4.0, {
		heading=0,
		minZ=-35.17,
  		maxZ=-32.37
	})
	...
	--mall
	exports["fa-polyzone"]:AddBoxZone("tattoo_shop", vector3(-587.07, -599.56, 41.43), 7.0, 7.4, {
		heading=0,
		minZ=38.83,
		maxZ=42.83
	})
