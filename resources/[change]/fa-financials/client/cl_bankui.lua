...
RegisterNetEvent("fa-financials:cash")
AddEventHandler("fa-financials:cash", function(pCash, pChange)
    if not pCash then return false, "No cash" end
    exports["fa-ui"]:cashFlash(pCash, pChange)
end)


RegisterCommand("cashh", function()
    TriggerServerEvent("fa-financials:cash:get")
end)
