...
itemList['deploy_xmas_tree_presents'] = {
  fullyDegrades: true,
  decayrate: 1.3,
  displayname: 'Small Xmas Tree',
  price: 4000,
  weight: 1,
  nonStack: false,
  model: '',
  image: 'np_christmas_present.png',
  information: "Small tree with presents",
...
itemList['deploy_xmas_tree_spin'] = {
  fullyDegrades: true,
  decayrate: 1.3,
  displayname: 'Small Spinning Xmas Tree',
  price: 4000,
  weight: 1,
  nonStack: false,
  model: '',
  image: 'np_christmas_present.png',
  information: "Small tree that spins",
...
itemList['deploy_xmas_tree_neon'] = {
  fullyDegrades: true,
  decayrate: 1.3,
  displayname: 'Small Neon Xmas Tree',
  price: 4000,
  weight: 1,
  nonStack: false,
  model: '',
  image: 'np_christmas_present.png',
  information: "Small tree with neons",
  deployableObject: "ch_prop_tree_02a",
  deployableExpires: 60 * 60 * 24 * 32,
};


itemList['deploy_xmas_tree_large'] = {
  fullyDegrades: true,
  decayrate: 1.3,
  displayname: 'Large Xmas Tree',
  price: 8000,
  weight: 1,
  nonStack: false,
  model: '',
  image: 'np_christmas_present.png',
  information: "Big mf tree",
  deployableObject: "prop_xmas_ext",
  deployableExpires: 60 * 60 * 24 * 32,
};
