...
PedEntries[#PedEntries+1] = {
  ...
  subMenus = {"fa-police:frisk", "fa-police:search", "fa-police:fingerprint", "fa-police:checkBank", "fa-police:gsr", "medic:checktargetstates", "fa-police:seizeItems"},
  isEnabled = function(pEntity, pContext)
...
PedEntries[#PedEntries+1] = {
    ...
    subMenus = {"fa-police:barrier1", "fa-police:barrier2", "fa-police:barrier3","fa-police:pickupp" },
    isEnabled = function(pEntity, pContext)
...
MenuItems['fa-police:barrier1'] = {
data = {
    id = "fa-police:barrier1",
    title = "Cone",
    icon = "#police-action-frisk",
    event = "barriers:cone",
    parameters = { true }
...
MenuItems['fa-police:barrier2'] = {
data = {
    id = "fa-police:barrier2",
    title = "Barrier",
    icon = "#police-action-frisk",
...
MenuItems['fa-police:barrier3'] = {
data = {
    id = "fa-police:barrier3",
    title = "Road Closure",
    icon = "#police-action-frisk",
...
MenuItems['fa-police:pickupp'] = {
data = {
    id = "fa-police:pickupp",
    title = "Pickup",
    icon = "#police-action-frisk",
...
MenuItems['fa-police:frisk'] = {
  data = {
      id = "peds-frisk",
      title = "Frisk",
      icon = "#police-action-frisk",
      event = "fa-police:frisk",
      parameters = { true }
  }
}

MenuItems['fa-police:search'] = {
  data = {
      id = "peds-search",
      title = "Search",
      icon = "#cuffs-check-inventory",
      event = "fa-police:checkInventory"
  }
}
...
MenuItems['fa-police:seizeItems'] = {
    data = {
        id = "fa-police:seizeItems",
        title = "Seize Possessions",
        icon = "#steal",
        event = "fa-police:seizeItems"
    },
    isEnabled = function(pEntity, pContext)
...
MenuItems['cuffs:beatmode'] = {
    data = {
        ...
        title = "Beat Mode",
        icon = "#cuffs-beatmode",
        event = "fa-police:startPutInBeatMode"
    }
}
...
MenuItems['fa-police:fingerprint'] = {
    data = {
        id = "fa-police:fingerprint",
        icon = "#police-action-fingerprint",
        title = "Check Fingerprint",
        event = "fa-police:fingerPrintPlayer"
    },
    isEnabled = function(pEntity, pContext)
...
MenuItems['fa-police:checkBank'] = {
    data = {
        id = "fa-police:checkBank",
        icon = "#police-check-bank",
        title = "Check Bank",
        event = "fa-police:checkBank"
    },
    isEnabled = function(pEntity, pContext)
...
MenuItems["fa-police:dnaSwab"] = {
    data = {
        id = "fa-police:dnaSwab",
        icon = "#police-action-fingerprint",
        title = "Collect DNA",
