...
RegisterNetEvent("fa-interface:open-application")
AddEventHandler("fa-interface:open-application", openApplication)
...
function closeApplication(app, data)
  ...
  TriggerEvent("fa-interface:application-closed", app, { fromEscape = false })
end
...
RegisterNetEvent("fa-interface:soundPlay")
AddEventHandler("fa-interface:soundPlay", function(name, volume, loop)
