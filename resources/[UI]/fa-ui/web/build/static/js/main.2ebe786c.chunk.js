      ...
      var FT = function (SU) {
          ...
          return (
            Fl('uiMessage', function (ch) {
              ...
              'badge' === ch.app &&
                ...
                SQ(true),
                setTimeout(function () {
                  Fd('fa-ui:closeApp', {}).then(function (cM) {
                    true === cM.meta.ok &&
                      Fd('fa-ui:applicationClosed', {
                        name: 'badge',
                        fromEscape: true,
                      }).then(function (cb) {
          ...
          Object(F4.useEffect)(
            function () {
              var cm = function (cs) {
                Fg.includes(cs.code) &&
                  ('eye' === cv
                    ? Fd('fa-ui:closeApp', {}).then(function (cR) {
                        true === cR.meta.ok &&
                          Fd('fa-ui:applicationClosed', {
                            name: 'eye',
                            fromEscape: true,
        ...
        Fp = function (SU) {
          ...
          var cr = function (cB, ch, cO, cP, cN, cJ) {
            ...
            void 0 !== cB
              ? (void 0 !== cO && false !== cO) ||
                Fd('fa-ui:closeApp', {}).then(function (cb) {
                  true === cb.meta.ok &&
                                    ...
                                    children: Object(FG.jsx)(S0.a, {
                                      onClick: function () {
                                        cM(true),
                                          cv(true),
                                          Fd(
                                            'fa-ui:getBankAccountsByStateID',
                                            { stateid: cR }
                                          ).then(function (cp) {
                                            cd('')
                                            cM(false)
                    ...
                    children: Object(FG.jsx)('div', {
                      children: Object(FG.jsx)(S0.a, {
                        onClick: function () {
                          ...
                          Fd('fa-ui:closeApp', {}).then(function (cw) {
                            true === cw.meta.ok &&
                              Fd(''.concat(c7), {
                                key: cS,
                                values: cZ,
                            ...
                            children: Object(FG.jsxs)(SZ.a, {
                              ...
                              children: [
                                ...
                                Object(FG.jsx)(S0.a, {
                                  onClick: function () {
                                    c4(false)
                                    Fd('fa-ui:closeApp', {}).then(
                                      function (aJ) {
                                        true === aJ.meta.ok &&
                                          Fd(
                                            'fa-ui:applicationClosed',
                                            {
                                              name: 'clothing',
                                              fromEscape: true,
                                            }
