    ...
    data = {
        {
            ...
            icon = "cut",
            event = "fa-miscscripts:carBombs:removeBomb",
            parameters = {}
        },
    },
    options = {
        distance = { radius = 1.8 },
        isEnabled = function(pEntity, pContext)
            return exports['fa-carbombs']:isThisVehicleABomb(NetworkGetNetworkIdFromEntity(pEntity))
        end
    }
}
...
Entries[#Entries + 1] = {
    ...
    options = {
        distance = { radius = 1.8 },
        isEnabled = function(pEntity, pContext)
            return exports['fa-activities']:canHandOffPackages() and exports['fa-inventory']:hasEnoughOfItem('darkmarketpackage', 1)
        end
    }
}
...
AddEventHandler("fa-polyzone:enter", function(pName)
  if pName ~= "custom_car_clothing" then return end
  inClothingShop = true
end)
AddEventHandler("fa-polyzone:exit", function(pName)
  if pName ~= "custom_car_clothing" then return end
    ...
    data = {
        {
            ...
            icon = "plus",
            event = "fa-car-clothing:saveCurrentOutfit",
            parameters = {},
        },
        {
            ...
            icon = "redo",
            event = "fa-car-clothing:swapCurrentOutfit",
            parameters = {},
        },
    },
    options = {
...
Entries[#Entries + 1] = {
    ...
    options = {
        ...
        isEnabled = function(pEntity, pContext)
            return exports['fa-fuel']:hasNozle()
        end
    }
}
    ...
    data = {
        {
            ...
            icon = "wrench",
            event = "pnp:vehicles:examineVehicle",
            parameters = {}
        }
    },
    options = {
    ...
    options = {
        ...
        isEnabled = function(pEntity, pContext)
            return (not (isCloseToHood(pEntity, PlayerPedId()) or isCloseToBoot(pEntity, PlayerPedId(), 2.0, pContext.model))
              or pContext.model == GetHashKey("emsnspeedo"))
              and not IsPedInAnyVehicle(PlayerPedId(), false)
              and NetworkGetEntityIsNetworked(pEntity) and exports['fa-boosting']:pCanFinishScratch()
        end
    }
}
