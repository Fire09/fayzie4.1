...
Citizen.CreateThread(function()
	exports["fa-polyzone"]:AddBoxZone("recyle_enter", vector3(892.37, -2171.84, 32.29), 1.4, 1, {
		name="recyle_enter",
		heading=85,
		--debugPoly=false,
		minZ=29.49,
	...
	exports["fa-polyzone"]:AddBoxZone("recycle_exit", vector3(997.49, -3091.93, -38.75), 1.2, 1, {
		name="recycle_exit",
		heading=0,
		--debugPoly=false,
		minZ=-41.75,
...
AddEventHandler('fa-polyzone:enter', function(name)
    if name == "recyle_enter" then
        nearRecyle = true
		exports["fa-interface"]:showInteraction('[E] Enter Recycle')
		NearRecyleSpot()
    elseif name == "recycle_exit" then
        nearExitRecyle = true
		exports["fa-interface"]:showInteraction('[E] Exit Recycle')
		ExitRecyle()
	end
end)
...
RegisterNetEvent('fa-trade:mats')
AddEventHandler('fa-trade:mats', function()
	local isEmployed = exports["fa-business"]:IsEmployedAt("recycle_center")
...
exports["fa-polytarget"]:AddCircleZone("recycle_trade",  vector3(995.23, -3100.04, -39.1), 0.3, {
	useZ = true
})

-- Recycling Center
exports["fa-interact"]:AddPeekEntryByPolyTarget("recycle_trade", {
	{
		event = "fa-trade:mats",
		id = "recycle_trade",
		icon = "circle",
