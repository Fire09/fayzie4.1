...
RegisterNetEvent("fa-editor:buildName")
AddEventHandler("fa-editor:buildName", function(name, objects)
    if objects then
...
RegisterNetEvent("fa-editor:destroyName")
AddEventHandler("fa-editor:destroyName", function(name)
    cleanUpArea(name)
