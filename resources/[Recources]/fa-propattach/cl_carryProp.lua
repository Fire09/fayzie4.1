...
Citizen.CreateThread(function()
  exports["fa-keybinds"]:registerKeyMapping("", "Player", "Drop Prop", "+propAttachDrop", "-propAttachDrop")
...
attachPropList = {
	...
	["bananaphone"] = {
		["model"] = "synced_np_bananaphone", ["bone"] = 57005, ["x"] = 0.15, ["y"] = 0.04,["z"] = 1.0408340855861e-17, ["xR"] = 22.0, ["yR"] = 119.0, ["zR"] = -51.0
	},
...
RegisterNetEvent('fa-propattach:attach')
AddEventHandler('fa-propattach:attach', function(pPropItem, pTargetFunction)
