...
local function returnBoat()
    ...
    local finished = exports["fa-taskbar"]:taskBar(1000, "Returning Boat")
    ...
    TriggerEvent("fa-fishing:currentlyRentedBoat", currentlyRentedBoat)
end

function rentBoat()
    boatsValeted = boatsValeted + 1
    FreezeEntityPosition(PlayerPedId(), true)
    local finished = exports["fa-taskbar"]:taskBar(1000, "Valeting Boat")
...
AddEventHandler("fa-fishing:rentBoat", function(name)
...
AddEventHandler("fa-fishing:returnBoat", function()
