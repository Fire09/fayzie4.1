...
RegisterNetEvent("fa-scenes:allScenes")
AddEventHandler("fa-scenes:allScenes", function(scenes)
  activeScenes = scenes
end)

RegisterNetEvent("fa-scenes:refreshScenes")
AddEventHandler("fa-scenes:refreshScenes", function(sceneId, scene)
...
AddEventHandler("fa-scenes:deleteScene", function(removeId)
  if removeId then
...
function calculateScenesToDraw()
  ...
  local isPeekActive = exports['fa-interact']:IsPeeking()
...
RegisterInterfaceCallback("fa-ui:scenes:input", function(data, cb)
  ...
  TriggerServerEvent("fa-scenes:addScene", {
    coords = activePos,
    text = text,
    distance = distance,
    color = color,
...
RegisterCommand("+startScene", function()
  if sceneStarted then
    ...
    exports['fa-interface']:openApplication('textbox', {
      callbackUrl = 'fa-ui:scenes:input',
      key = 1,
      items = {
        {
          icon = "pencil-alt",
...
RegisterCommand("+deleteScene", function()
  ...
  TriggerServerEvent("fa-scenes:deleteScene", GetEntityCoords(PlayerPedId()))
end, false)
RegisterCommand("-deleteScene", function() end, false)

Citizen.CreateThread(function()
  exports["fa-keybinds"]:registerKeyMapping("", "Scenes", "Start / Place Scene", "+startScene", "-startScene")
  exports["fa-keybinds"]:registerKeyMapping("", "Scenes", "Enable / Disable", "+enableScene", "-enableScene")
  exports["fa-keybinds"]:registerKeyMapping("", "Scenes", "Delete Closest Scene", "+deleteScene", "-deleteScene")
  RequestStreamedTextureDict('commonmenu', true)
  Wait(5000)
  TriggerServerEvent("fa-scenes:getScenes")
end)