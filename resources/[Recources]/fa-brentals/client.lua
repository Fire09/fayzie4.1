RegisterNetEvent('fa-bikerent:menu')
AddEventHandler('fa-bikerent:menu', function()                           
...
RegisterNetEvent('fa-bikerent:checkmoney')
AddEventHandler('fa-bikerent:checkmoney', function(data)                            
        local vehicle = data.car
        local price = data.price
        TriggerServerEvent("fa-bikerent:hasmoney", price, vehicle)

end)

RegisterNetEvent('fa-bikerent:spawnbike')
AddEventHandler('fa-bikerent:spawnbike', function(vehicleName)                            
