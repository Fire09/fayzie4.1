...
function startRaceCreation(options)
    ...
    while raceName ~= nil and options.raceName == nil and RPC.execute("fa-racing:isRaceNameTaken", raceName) == true do
...
function finishRaceCreation()
    ...
    TriggerServerEvent("fa-racing:recieveCreateData", raceName, raceType, raceThumbnail, checkpoints)
...
RegisterNetEvent("fa-racing:cmd:racecreate")
AddEventHandler("fa-racing:cmd:racecreate", function(options)
    if GetVehiclePedIsIn(PlayerPedId(), false) ~= 0 then
        startRaceCreation(options)
    end
end)

RegisterNetEvent("fa-racing:cmd:racecreatedone")
AddEventHandler("fa-racing:cmd:racecreatedone", function()
    finishRaceCreation()
end)

RegisterNetEvent("fa-racing:cmd:racecreatecancel")
AddEventHandler("fa-racing:cmd:racecreatecancel", function()
    cancelRaceCreation()
end)
