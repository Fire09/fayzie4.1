...
function DPX.DataControls.setBindTable(controlTable,shouldSend)
	if controlTable == nil then
		...
		TriggerServerEvent('fa-base:sv:player_control_set',DPX.Controls.Current)
...
RegisterNetEvent("fa-base:cl:player_control")
AddEventHandler("fa-base:cl:player_control", function(controlTable)
...
RegisterNetEvent('fa-base:setcontrols')
AddEventHandler('fa-base:setcontrols', function()
	TriggerServerEvent('fa-base:sv:player_controls')
end)
