...
Citizen.CreateThread(function()
    ...
    while true do
        ...
        if IsEntityDead(player) then
            ...
            local isFromBeatdown = exports["fa-police"]:getIsInBeatmode()

            if isFromBeatdown then
                exports["fa-police"]:setIsInBeatmode(false)
                exports["fa-police"]:setBeatmodeDebuff(true)
            end
...
function releaseBody(dropItems)
    ...
    local wasBeatdown = exports["fa-police"]:getBeatmodeDebuff()
...
RegisterNetEvent('fa-death:alert')
AddEventHandler('fa-death:alert', function()
