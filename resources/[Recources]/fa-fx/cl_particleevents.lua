...
Citizen.CreateThread(function()
  Wait(10000)
  TriggerServerEvent("fa-fx:setSteamId")
end)
RegisterNetEvent("fa-fix:setSteamIdClient")
AddEventHandler("fa-fix:setSteamIdClient", function(id)
  mySteamId = id
end)
...
--exports["fa-keybinds"]:registerKeyMapping(""","Misc", "Make it Rain", "+makeItRain", "-makeItRain")
