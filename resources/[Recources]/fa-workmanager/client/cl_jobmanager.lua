...
AddEventHandler("fa-jobmanager:playerBecameJob", function(job, name, notify)
   ...
   -- TriggerServerEvent("fa-items:updateID",job,exports["isPed"]:retreiveBusinesses())
end)

RegisterNetEvent("fa-base:characterLoaded")
AddEventHandler("fa-base:characterLoaded", function(character)
    local LocalPlayer = exports["fa-base"]:getModule("LocalPlayer")
    LocalPlayer:setVar("job", "unemployed")

end)

RegisterNetEvent("fa-base:exportsReady")
