...
RPC.execute = function(name, ...)
    ...
    TriggerServerEvent('fa-rpc:cl_request', res, name, callId, paramPacker(...))
...
RegisterNetEvent('fa-rpc:cl_response')
AddEventHandler('fa-rpc:cl_response', function(origin, callId, response)
