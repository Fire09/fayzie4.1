...
RegisterNetEvent('fa-rpc:cl_request')
AddEventHandler('fa-rpc:cl_request', function(origin, name, callId, params)
    local response
    local src = source
    ...
    TriggerClientEvent('fa-rpc:cl_response', src, origin, callId, response)
end)