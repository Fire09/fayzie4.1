...
RegisterNetEvent("fa-sceneui:open-application")
AddEventHandler("fa-sceneui:open-application", openApplication)
...
function closeApplication(app, data)
  ...
  TriggerEvent("fa-sceneui:application-closed", app, { fromEscape = false })
end
