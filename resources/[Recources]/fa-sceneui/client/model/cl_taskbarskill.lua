...
function taskBarSkillCheck(difficulty, skillGapSent, cb, reverse, usePrev)
  ...
  local duration = difficulty * (math.min(exports["fa-buffs"]:getAlertLevelMultiplier(), 1.33))
  ...
  exports['fa-actionbar']:disableActionBar(true)
  ...
  SetTimeout(500, function()
    if not tbsListening then
      exports['fa-actionbar']:disableActionBar(false)
