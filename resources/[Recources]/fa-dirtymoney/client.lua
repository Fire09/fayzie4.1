...
RegisterNetEvent("fa-dirtymoney:allowDirtyMoneyDrops")
AddEventHandler("fa-dirtymoney:allowDirtyMoneyDrops", function()
...
RegisterNetEvent("fa-dirtymoney:attemptDirtyMoneyDrops")
AddEventHandler("fa-dirtymoney:attemptDirtyMoneyDrops", function()
	if DropOffTime == 0 then
		TriggerEvent('fa-dirtymoney:allowDirtyMoneyDrops')
		--TriggerServerEvent('mobdelivery:checkjob')
		--TriggerServerEvent("fa-dirtymoney:alterDirtyMoney", "TurnToCash", 0)
	else
...
if DirtyMoney >= amount then
	local pos = GetEntityCoords(PlayerPedId())
		...
		TriggerServerEvent("fa-dirtymoney:alterDirtyMoney","ItemDrop",amount)
