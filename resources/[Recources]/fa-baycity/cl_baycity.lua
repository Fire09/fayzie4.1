...
-- -105.12893676758, 6471.46484375, 31.626705169678 Heading: 40.885322570801
            if exports["fa-inventory"]:hasEnoughOfItem("thermite",1,false) then
                FreezeEntityPosition(PlayerPedId(),true)
                local FirstDoorBigBank = exports["fa-taskbar"]:taskBar(9000,"Preparing For Hack")
                if FirstDoorBigBank == 100 then
                    ...
                    function() -- Success
                        ...
                        TriggerEvent('fa-vaultDoor3', -1, method)
                        --TriggerEvent('fa-ffs2:startheist')
                    ...
                    --     function() -- success
                    --         StopAnimTask(PlayerPedId(), hackAnimDict, "hack_loop", 1.0)
                    --         TriggerEvent('fa-vaultDoor2', -1, method)
                    --         TriggerEvent('fa-ffs2:startheist')
    ...
    if distance < 1.5 then
        if exports["fa-inventory"]:hasEnoughOfItem("thermite",1,false) then
            ...
            if FirstDoorBigBank == 100 then
                ...
                exports["memorygame"]:thermiteminigame(1, 3, 4, 10,
                function() -- Success
                    TriggerEvent("fa-BayCityTriggerSecondDoor")
                    TriggerEvent("inventory:removeItem","thermite",1)
                    TriggerEvent('DoLongHudText', 'Well done dumbass please cry more!', 2)
                end,
                function() -- failure
...
RegisterNetEvent('fa-BayCityTriggerSecondDoor')
AddEventHandler('fa-BayCityTriggerSecondDoor', function()
	anim66()
	Citizen.Wait(3500)
end)

RegisterNetEvent('fa-Seconddoorsbaycity') 
AddEventHandler('fa-Seconddoorsbaycity', function()
    TriggerServerEvent("fa-doors:change-lock-state", 524, false)
end)
    ...
    if distance < 1.5 then
        if exports["fa-inventory"]:hasEnoughOfItem("thermite",1,false) then
            ...
            if FirstDoorBigBank == 100 then
                ...
                exports["memorygame"]:thermiteminigame(1, 3, 4, 10,
                function() -- Success
                    TriggerEvent("fa-BayCityTriggerFirstDoor")
                    TriggerEvent("inventory:removeItem","thermite",1)
                    TriggerEvent('DoLongHudText', 'Well done dumbass please cry more!', 2)
...
RegisterNetEvent('fa-BayCityTriggerFirstDoor')
AddEventHandler('fa-BayCityTriggerFirstDoor', function()
	anim69()
	Citizen.Wait(3500)
end)

RegisterNetEvent('fa-firstdoorsbaycity') 
AddEventHandler('fa-firstdoorsbaycity', function()
    TriggerServerEvent("fa-doors:change-lock-state", 525, false)
end)
...
RegisterNetEvent('fa-vaultDoor3')
AddEventHandler('fa-vaultDoor3', function(method)
...
RegisterNetEvent("fa-baycity:getDoorCheckCL")
AddEventHandler("fa-baycity:getDoorCheckCL", function(result)
...
Citizen.CreateThread(function()
    ...
    while true do 
        ...
        if isNear then
            TriggerServerEvent('fa-baycity:getGetDoorStateSV')
...
RegisterNetEvent("fa-ptfxparticlebaycity")
AddEventHandler("fa-ptfxparticlebaycity", function(method)
    local ptfx
...
-- 252.99769592285, 220.96379089355, 101.68360137939 Heading: 166.93214416504
    ...
    TriggerServerEvent("fa-particleserverbaycity", method)
    SetPtfxAssetNextCall("scr_ornate_heist")
    local effect = StartParticleFxLoopedAtCoord("scr_heist_ornate_thermal_burn", ptfx, 0.0, 0.0, 0.0, 1.0, false, false, false, false)
    ...
    DeleteObject(bomba)
    StopParticleFxLooped(effect, 0)
	TriggerEvent("fa-Seconddoorsbaycity")
end

RegisterNetEvent("fa-ptfxparticlebaycity1")
AddEventHandler("fa-ptfxparticlebaycity1", function(method)
    local ptfx
...
-- 252.99769592285, 220.96379089355, 101.68360137939 Heading: 166.93214416504
    ...
    DetachEntity(bomba, 1, 1)
    FreezeEntityPosition(bomba, true)
    TriggerServerEvent("fa-particleserverbaycity1", method)
    SetPtfxAssetNextCall("scr_ornate_heist")
    local effect = StartParticleFxLoopedAtCoord("scr_heist_ornate_thermal_burn", ptfx, 0.0, 0.0, 0.0, 1.0, false, false, false, false)
    ...
    DeleteObject(bomba)
    StopParticleFxLooped(effect, 0)
	TriggerEvent("fa-firstdoorsbaycity")
end