...
Citizen.CreateThread(function()
    ...
    while(true) do
		...
		if addedPolyZone == false then
			    exports["fa-polyzone"]:AddBoxZone("carrent", vector3(110.4619140625, -1090.6267089844, 29.302474975586), 0.8, 0.9, {
				name="carrent",
				heading=331.47,
				debugPoly=false,
				minZ=22.37,
...
--RegisterNetEvent('fa-carrent:menu')
--AddEventHandler('fa-carrent:menu', function()   
...
RegisterNetEvent('fa-carrent:checkmoney')
AddEventHandler('fa-carrent:checkmoney', function(data)                            
        local vehicle = data.car
        local price = data.price
        TriggerServerEvent("fa-carrent:hasmoney", price, vehicle)

end)

RegisterNetEvent('fa-carrent:spawncar')
AddEventHandler('fa-carrent:spawncar', function(vehicleName)                            
