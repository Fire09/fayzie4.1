...
RegisterNetEvent("fayzie:voice:phone:call:start")
AddEventHandler('fayzie:voice:phone:call:start', function (serverId, callId)
...
function LoadPhoneModule()
    ...
    --[[ RegisterNetEvent("fayzie:voice:phone:call:start")
    AddEventHandler("fayzie:voice:phone:call:start", StartPhoneCall) ]]

    RegisterNetEvent("fayzie:voice:phone:call:end")
    AddEventHandler("fayzie:voice:phone:call:end", StopPhoneCall)
    ...
    TriggerEvent("fayzie:voice:phone:ready")

    Debug("[Phone] Module Loaded")
end

RegisterNetEvent("fa-voice:setTransmissionDisabled", function ()
    WasEventCanceled()
