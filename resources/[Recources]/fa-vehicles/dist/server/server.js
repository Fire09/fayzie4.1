;(() => {
  ...
  var _0x370f39 = {
      ...
      558: (_0x26745d, _0x36236b, _0x491527) => {
        ...
        RPC.register('pnp:vehicles:giveKey', (_0x5ceeb5, _0x21199b) => {
            emitNet('pnp:vehicles:addKey', Number(_0x21199b), _0x5ceeb5)
            emitNet('DoLongHudText', Number(_0x21199b), 'You just received keys to a vehicle!')
          }
        )
        RPC.register('pnp:vehicles:sellPhone', async (_0x692882, _0x135d4d, _0x4b7fc2, _0x75dd77, _0x1e096b) => {
            emitNet(
              'pnp:vehicles:sellNotify',
              -1,
              Number(_0x4b7fc2),
              Number(_0x135d4d),
              _0x75dd77,
        ...
        RPC.register('pnp:vehicles:sell:vehicle', async (_0x196694, _0x16903a, _0x424495, _0x467ccb, _0x20b4f8) => {

        })
        RPC.register('pnp:vehicles:getVehicles', async (_0x44805f) =>
            (await SQL.execute('SELECT * FROM characters_cars WHERE garage = @garage',
              { garage: _0x44805f }
            )) || []
        )
        RPC.register('pnp:vehicles:getSharedVehicles', async (pGarage, pCurrentGarage) => {
          if (!Array.isArray(pGarage)) {
            return (
              (await SQL.execute('SELECT * FROM characters_cars WHERE shared_job = @shared_job AND garage = @garage AND NOT state = @state',
                {
                  shared_job: pGarage,
        ...
        RPC.register('pnp:vehicles:degradation:requestRepair', async (_0xa9bc28, _0x3d3daf, _0x4a44b5) => {
        ...
        RPC.register('pnp:vehicles:degradation:doRepair', (_0x3f9799, _0x2d8a13, _0x386c94, _0x2c954a) => {
            if (_0x2c954a) {
        ...
        RPC.register('pnp:vehicles:addDegradation', async (_0xda185b, _0x585be2) => {
        ...
        RPC.register('pnp:vehicles:spawnGarageVehicle', async (_0x9011bb, _0x363b0d, _0x543f40) => {
          let src = _0x491527.g.source
            ...
            if (_0x6281ce.success) {
              if (
                !(await SQL.execute('UPDATE characters_cars SET state = @state WHERE vin = @vin',
                  {
                    state: 'out',
                    vin: _0x9011bb,
                  }
              ...
              return !(
                _0x18e13c.vin &&
                !(await SQL.execute('INSERT INTO parking_logs (vin, cid, action, engine, body, fuel, timestamp, garage) VALUES (@vin, @cid, @action, @engine, @body, @fuel, @timestamp, @garage)',
                  {
                    vin: _0x9011bb,
        ...
        RPC.register('pnp:vehicles:fetchParkingLogs', async (_0xacf134, _0x5db31f) => {
            const _0x254830 = await SQL.execute('SELECT * FROM parking_logs WHERE vin = @vin AND garage = @garage ORDER BY id DESC',
              {
                vin: _0xacf134,
                garage: _0x5db31f,
              }
        ...
        RPC.register('pnp:vehicles:generateVehicleInformation', async (pVeh, pModel) => {
        ...
        RPC.register('pnp:vehicles:storeVehicle', async (_0x4852cf, _0x52a9eb) => {
        ...
        RPC.register('fa-vehicles:damage:saveDamage', (_0xa07cad) => {
            const _0x407867 = NetworkGetEntityFromNetworkId(_0xa07cad)
            ;(0, _0x13b062.SaveVehicleDamage)(_0x407867)
          }
        )
        RPC.register('pnp:vehicles:getFuelPrice', (_0x566069) => ({
          taxLevel: 15,
          fuelPrice: 3,
        }))
        RPC.register('pnp:vehicles:GetVehicleWheelFitment', (netId) => {
        ...
        RPC.register('pnp:vehicles:GetVehicleAfterMarket', async (netId, pType) => {
          let veh = NetworkGetEntityFromNetworkId(netId)
        ...
        RPC.register('pnp:vehicles:addFuel', (_0x40234e, _0x475373, _0x410e8b, _0x47d67b, _0x4356d9, _0x3527e5) => {
            const _0x18add5 = NetworkGetEntityFromNetworkId(_0x40234e)
            ;(0, _0x917faf.AddVehicleFuel)(_0x18add5, _0x475373)
          }
        )
        RPC.register('pnp:vehicles:setFakeLicensePlate', async ( _0x26eb8d, _0x4e101f) =>{
        let src = _0x491527.g.source
        await (0, _0xdfced7.SetVehicleFakeLicensePlate)(src, _0x26eb8d, _0x4e101f)
        })
        RPC.register('pnp:vehicles:getLicensePlate', async (_0x52f9f6) =>
            await (0, _0xdfced7.GetLicensePlate)(_0x52f9f6)
        )
        RPC.register('fa-vehicles:chargeForNOSRefill', async (_0x4dc379) => {

        })
        RPC.register('fa-vehicles:chargeForFuelRefill', async (_0x2a7e28) => {
            let src = _0x491527.g.source
        ...
        RPC.register('pnp:vehicles:respawnVehicle', async (_0x3b614b, _0x4d0676, _0x5e7d81, _0x37badb, _0x4834d8) => {
          !!(
        ...
        _0x5e2697.Procedures.register('pnp:vehicles:respawnVehicle', async (_0x3b614b, _0x4d0676, _0x5e7d81, _0x37badb, _0x4834d8) =>
            !!(
              await (0, _0x50099c.SpawnPlayerVehicle)(
                _0x3b614b,
                _0x4d0676,
        ...
        _0x5e2697.Procedures.register('pnp:vehicles:basicSpawn', async (
            _0x338fc8,
            _0x153c96,
            _0x34012d,
            _0x4c263b,
        ...
        onNet("pnp:vehicles:InsertVehicleData", (src, data) => {
          const info = SQL.execute('INSERT INTO characters_cars (vin, cid, model, state, plate, garage, name, type, size, degradation, metadata, damage, mods, appearance, vinScratched) VALUES (@vin, @cid, @model, @state, @plate, @garage, @name, @type, @size, @degradation, @metadata, @damage, @mods, @appearance, @vinScratched)',
          {
            vin : data.vin,
            cid : data.cid,
            model : data.model,
        ...
        onNet('fa-vehicles:updateVehicle', async (_0x579a8a, _0x44c07d, _0x5784e4) => {
            _0x579a8a &&
              (await SQL.execute('UPDATE characters_cars SET appearance = @appearance, mods = @mods WHERE plate = @plate',
                {
        ...
        onNet('pnp:vehicles:DoHarnessDamage', (_0x12fe1d, _0x3d5486) => {
          ;(0, _0x109f31.DoHarnessDamage)(_0x12fe1d, _0x3d5486)
        })
        onNet('pnp:vehicles:UpdateGarage', (src, pVin, pGarage) => {
          const update =  SQL.execute('UPDATE characters_cars SET garage = @garage WHERE vin = @vin',
            {
              garage: pGarage,
              vin: pVin,
            }
        ...
        onNet('pnp:vehicles:generateMetadata', (_0x12f116) => {
            ...
            if (_0x64e98b) {
              if (_0x4bc356) {
                ...
                return (
                  ...
                  !!_0x264c25.state.vin &&
                    (await SQL.execute('UPDATE characters_cars SET metadata = @metadata WHERE vin = @vin',
                      {
      ...
      905: (_0x1751da, _0x4aba12, _0x1454d3) => {
        ...
        async function _0x47f131(_0x4f8e64, _0x1f4774) {
          ...
          return emitNet("fa-vehicles:spawnedVehicle", src, netId), (_0x1f4774.damage && (await RPC.execute('RestoreVehicleDamage', src, netId, _0x1f4774.damage)),
            ...
            _0x1f4774.metadata?.wheelFitment && emitNet('fa-wheelfitment_cl:applySavedWheelFitment', src, _0x1f4774.metadata?.wheelFitment, netId),  
        ...
        async function _0x711612(_0x41c7b9, _0x2fc86e, _0x10205d, _0x31b602 = 0, _0x176e78, _0xa71608, _0x3aa394, _0x49a5bf, _0x306c32, _0x50b3e9, _0x456dd3, _0x3a74d4 = true) {
          const _0x166892 = 'number' != typeof _0x2fc86e ? GetHashKey(_0x2fc86e) : _0x2fc86e,
            // [_0x56d521] = await RPC.execute('pnp:vehicles:getWaterHeight', _0x41c7b9),
          ...
          TriggerEvent('fa-supression:bypass', _0x270cda)
          const _0x13977b = {
            vin: _0x176e78,
            model: _0x2fc86e,
            plate: _0xa71608,
        ...
        _0x4aba12.InsertVehicleData = async function (src, data) {
          const info = SQL.execute('INSERT INTO characters_cars (vin, cid, model, state, plate, garage, name, type, size, degradation, metadata, damage, mods, appearance, records, vinScratched) VALUES (?, ? , ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)',
            {
              vin : data.vin,
              cid : data.cid,
              model : data.model,
      ...
      237: (_0x555701, _0x418384, _0x545cd9) => {
        ...
        _0x418384.StoreVehicleInGarage = async function (_0x551809, _0x99b1cc, _0x370a34) {
          ...
          if (_0x257a8e && _0x257a8e.vin) {
            if (
              !(await SQL.execute('UPDATE characters_cars SET state = @state, degradation = @degradation, metadata = @metadata, damage = @damage, mods = @mods, appearance = @appearance, garage = @garage WHERE vin = @vin',
                {
                  state: 'stored',
        ...
        RPC.register('pnp:vehicles:getPlayerVehicles', async (_0x43bd32, _0x5155be) =>
            (await SQL.execute('SELECT * FROM characters_cars WHERE cid = @cid AND garage = @garage AND NOT state = @state',
              {
                cid: _0x43bd32,
                garage: _0x5155be,
                state: 'out',
        ...
        RPC.register('pnp:vehicles:getAllPlayerVehicles', async (_0x188351) =>
            (await SQL.execute('SELECT * FROM characters_cars WHERE cid = @cid',
              { cid: _0x188351 }
            )) || []
        )
        RPC.register('pnp:vehicles:getPlayerVehiclesByCharacterId', async ( _0x4a5794) =>
            (await SQL.execute('SELECT * FROM characters_cars WHERE cid = @cid',
              { cid: _0x4a5794 }
            )) || []
        )
      ...
      827: (_0xdf067b, _0xb0f2a2) => {
        ...
        _0xb0f2a2.AddKey = function (_0x31830b, _0x544c12) {
          emitNet('pnp:vehicles:addKey', _0x31830b, _0x544c12)
        }
      },
      130: (_0x4b5582, _0x211f5c, _0x880c8e) => {
        ...
        _0x211f5c.FetchVehicleInfo = async function (_0x25c1ba, _0x28ed84) {
          const _0x4570af = await SQL.execute('SELECT * FROM characters_cars WHERE vin = @vin',
            { vin: _0x25c1ba }
            )
            return (
            !!_0x4570af[0] &&
      ...
      912: (_0xaefc6b, _0xb4f0fc, _0x595722) => {
        ...
        _0xb4f0fc.SetVehicleDegradation = async function (
          ...
          return (
            ...
            _0x24e281.state.vin &&
              (await SQL.execute('UPDATE characters_cars SET degradation = @degradation WHERE vin = @vin',
                {
        ...
        _0xb4f0fc.SaveVehicleDamage = async function (_0x23eab5) {
          ...
          _0x16aff8 &&
            _0x16aff8.vin &&
            _0x16aff8.damage &&
            (await SQL.execute('UPDATE characters_cars SET damage = @damage WHERE vin = @vin',
              {
      ...
      804: function (_0x924d6c, _0x10a4b6, _0x1ecf3f) {
        ...
        _0x10a4b6.Base =
          ...
          _0x10a4b6.Events =
            void 0
        _0x10a4b6.Events = {
          on: (_0x312200, _0xf85918) => FYX.Events.on(_0x312200, _0xf85918),
          onNet: (_0x466dba, _0x554869) =>
            FYX.Events.onNet(_0x466dba, _0x554869),
          emit: (_0x2a7311, ..._0x42cc1a) =>
            FYX.Events.emit(_0x2a7311, ..._0x42cc1a),
          emitNet: (_0x2c40bc, ..._0x1d6340) =>
            FYX.Events.emitNet(_0x2c40bc, ..._0x1d6340),
          remove: (_0x3199e9, _0x5c8af6) =>
            FYX.Events.remove(_0x3199e9, _0x5c8af6),
        }
        _0x10a4b6.Procedures = {
          register: (_0x34294c, _0x5ce5f3) =>
            FYX.Procedures.register(_0x34294c, _0x5ce5f3),
          execute: (_0x56c083, ..._0x290590) =>
            FYX.Procedures.execute(_0x56c083, ..._0x290590),
        }
        _0x10a4b6.Zones = {
          isActive: (_0x36c89b, _0x2290e2) =>
            FYX.Zones.isActive(_0x36c89b, _0x2290e2),
          onEnter: (_0xfd1ad2, _0x45b67c) =>
            FYX.Zones.onEnter(_0xfd1ad2, _0x45b67c),
          onExit: (_0x498c71, _0x5bb987) =>
            FYX.Zones.onExit(_0x498c71, _0x5bb987),
          addBoxZone: (
            _0x514f21,
            _0x5de599,
            _0x5dbb0e,
        ...
        _0x10a4b6.Streaming = {
          loadModel: (_0x390da7) => FYX.Streaming.loadModel(_0x390da7),
          loadTexture: (_0x20939b) => FYX.Streaming.loadTexture(_0x20939b),
          loadAnim: (_0x420149) => FYX.Streaming.loadAnim(_0x420149),
          loadClipSet: (_0x4354a9) => FYX.Streaming.loadClipSet(_0x4354a9),
          loadWeaponAsset: (_0x35b240, _0x3bce6e, _0x57e084) =>
            FYX.Streaming.loadWeaponAsset(_0x35b240),
          loadNamedPtfxAsset: (_0x1c9622) =>
            FYX.Streaming.loadNamedPtfxAsset(_0x1c9622),
        }
        _0x10a4b6.Utils = {
          cache: (_0x2851ca, _0x1e4ebe) =>
            FYX.Utils.cache(_0x2851ca, _0x1e4ebe),
          cacheableMap: (_0x51037f, _0x3010cb) =>
            FYX.Utils.cacheableMap(_0x51037f, _0x3010cb),
          waitForCondition: (_0x1b4537, _0x5b0a28) =>
            FYX.Utils.waitForCondition(_0x1b4537, _0x5b0a28),
          getMapRange: (_0x32e478, _0x2c7a15, _0x28da7f) =>
            FYX.Utils.getMapRange(_0x32e478, _0x2c7a15, _0x28da7f),
          getDistance: (
            [_0x220eaa, _0x2e08e6, _0x57fee1],
            [_0x255a4a, _0x3180f0, _0x551a17]
          ) =>
            FYX.Utils.getDistance(
              [_0x220eaa, _0x2e08e6, _0x57fee1],
              [_0x255a4a, _0x3180f0, _0x551a17]
            ),
          getRandomNumber: (_0x3aec10, _0x2c98f2) =>
            FYX.Utils.getRandomNumber(_0x3aec10, _0x2c98f2),
        }
        _0x10a4b6.Interface = {
          addPeekEntryByModel: (_0x287efb, _0x31b661, _0x5a9107) =>
            FYX.Interface.addPeekEntryByModel(_0x287efb, _0x31b661, _0x5a9107),
          addPeekEntryByTarget: (_0x63a41, _0x21c9cf, _0x3ab08a) =>
            FYX.Interface.addPeekEntryByTarget(_0x63a41, _0x21c9cf, _0x3ab08a),
          addPeekEntryByFlag: (_0x48d7cd, _0x30f292, _0x124110) =>
            FYX.Interface.addPeekEntryByFlag(_0x48d7cd, _0x30f292, _0x124110),
          taskbar: (
            _0xb9a6cd,
            _0x6d6600,
            _0x2ed474 = false,
            ...
            FYX.Interface.taskbar(_0xb9a6cd, _0x6d6600, _0x2ed474, _0x2bfcc7),
          phoneConfirmation: (
            _0x298b0c,
            _0x1bd45d,
            _0xb47af8 = 30,
            ...
            FYX.Interface.phoneConfirmation(
              _0xb47af8,
              _0x298b0c,
              _0x1bd45d,
              'home'
          ...
          phoneNotification: (
            ...
            FYX.Interface.phoneNotification(
              _0x328727,
              _0x3683b2,
              _0xd6a392,
              _0x1eafad
        ...
        _0x10a4b6.Hud = {
          createBlip: (_0x551b48, ..._0x40445a) =>
            FYX.Hud.createBlip(_0x551b48, ..._0x40445a),
          applyBlipSettings: (
            _0x51448b,
            _0x3181d9,
            _0xdb5c,
        ...
        _0x10a4b6.Base = {
          getModule: (_0x2178c2) => {
            if ('Player' === _0x2178c2) {
              return {
                GetUser: (_0x355699) => {
                  const _0x193329 = _0x1ecf3f.g.exports['fa-base']
                    .getModule(_0x2178c2)
                  ...
                  return (
                    !!_0x193329 && {
                      ...
                      addMoney: (_0x4494d5) => {
                        ...
                        const _0x816101 = _0x1ecf3f.g.exports['fa-base']
                          .getModule(_0x2178c2)
                          .GetUser(this, _0x355699)
                      ...
                      removeMoney: (_0x14138a) => {
                        ...
                        const _0x194ce3 = _0x1ecf3f.g.exports['fa-base']
                          .getModule(_0x2178c2)
                          .GetUser(this, _0x355699)
                      ...
                      addBank: (_0x451b92) => {
                        ...
                        const _0x38593c = _0x1ecf3f.g.exports['fa-base']
                          .getModule(_0x2178c2)
                          .GetUser(this, _0x355699)
                      ...
                      removeBank: (_0x2ebaad) => {
                        ...
                        const _0x22ef5e = _0x1ecf3f.g.exports['fa-base']
                          .getModule(_0x2178c2)
                          .GetUser(this, _0x355699)
