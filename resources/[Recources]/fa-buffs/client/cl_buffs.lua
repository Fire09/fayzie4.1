...
AddEventHandler("cool-buffs:stamina", function(pEnabled, pPercent)
...
AddEventHandler("cool-buffs:setJobLuckMultiplier", function(pJobLuckMultiplier)
  jobLuckMultiplier = 1 + pJobLuckMultiplier + 0.0
  TriggerServerEvent("cool-buffs:setBuffValue", "jobluck", jobLuckMultiplier)
end)
...
AddEventHandler("cool-buffs:setAlertLevelMultiplier", function(pAlertLevelMultiplier)
...
AddEventHandler("cool-buffs:inDoubleBuffZone", function(pBool)
  ...
  Citizen.CreateThread(function()
    ...
    while isSitting and inRestaurantBuffZone do
      if minuteCount >= 5 then
        ...
        TriggerEvent("cool-buffs:applyBuff", "restaurant_double", {{ buff = "double", percent = percent }})
      end
      Citizen.Wait(60000)
